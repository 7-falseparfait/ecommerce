...
addToCartButtons.forEach(button => {
    ...
    button.addEventListener('click', function () {
      ...
      const priceText = productCard.querySelector('.price-container').querySelector('.current-price').textContent.trim();  
      const cleanPrice = priceText.replace(/[^0-9.]/g, "");
      const image = productCard.querySelector('.image-container').querySelector('img'); 
